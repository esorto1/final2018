...
For each variable, we will make separate data results for Graphical, Numerical, and Inferential results. The methods that we'll be using for each one would be barchartGC, colPerc and rowPerc, chisqtestGC and fisher.test.  
...
The results are categorized into three sections Graphical, Numerical, and Inferential.  
...
The graph above displays every participant that took the drug and the placebo. From the data, it seems that those that took the placebo had a higher chance of getting the virus than those whot took the drug. This indicates that the drug is actually working since those that took the drug had a lesser chance of getting the virus.  
...
The graph above shows women taking the placebo and the drug. As shown in the graph, it appears that those that took the  drug got aids than those that took the placebo. However, it appears that it was only a slight difference.
...
The graph above shows the LGBT community taking the drug and placebo. In this group, it appears that those that took the drug ended up having higher chances of getting aids than those that took the placebo. This data results is odd since other variables, such as gene and drug users justifies that the drug is working. There must be some outside factor affecting this group.  
...
From the data above, it shows that those who had the placebo has a higher change of contracting aids. Since The placebo group had a 1.5% high. Potentally making the effects of the real drug working.  
...
Two out of the four variables, showed results of the drug working. Those groups were the Drug users and Males, both demonstrating an overall effectiveness of the medication by having a lesser chance of getting aids. The other variables, Females and the LBGT community had the opposite effect for them. In each dataset, it appears that the medication did not work out as well as the Drug users/Males, but rather increased the proability of getting aids. There must be some outside factor that influences both Females and the LBGT community of getting aids through the medication. 